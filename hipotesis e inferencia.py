...
import random
import nose
from probabilidades import normal_cdf, inverse_normal_cdf
...
def normal_probalility_above(lo,mu=0,sigma=1):
...
def normal_probability_outside(lo, hi, mu=0, sigma=1):
    ...
    #A PARTIR DE AQUI ES COPIADO DEL LIBRO, YO NO LO DIGITE
######
#
#  normal bounds
#
...
def two_sided_p_value(x, mu=0, sigma=1):
    if x >= mu:
        ...
        return 2 * normal_probalility_above(x, mu, sigma)
    else:
...
upper_p_value = normal_probalility_above
